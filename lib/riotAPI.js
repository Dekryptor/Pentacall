...
//            addChampionMasterys(teamMates,plattformID,server);
...
exports.getChampionMastery= function(summonerId,championId,server,callback) {
    var plattformID;
    ...
    request("https://"+server+".api.pvp.net/championmastery/location/"+plattformID+"/player/"+summonerId+"/champion/"+championId+"?api_key="+key,function (err,res,b) {
        console.log(res.statusCode);
        callback(b,res.statusCode);
    });
